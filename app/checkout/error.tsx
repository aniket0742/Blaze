...
export default function CheckoutError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6">
      <h1 className="text-2xl font-semibold tracking-tight">Checkout isn&apos;t responding</h1>
      <p className="mx-auto mt-2 max-w-md text-sm text-muted">
        No order was placed and nothing was charged. Your cart is exactly as you left it.
      </p>
